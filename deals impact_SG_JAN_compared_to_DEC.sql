...
--TIME PARAMETARS AUTOMATIC
--PUT ALL FO OR FP COUNTRIES INTO ONE SCRIPT
--CHANGE THE MONTH AUTOMATICALLY (select vendor_code from dwh_st.zhan_Confirmation_Month where rdbms_id=15 AND deals_month IN ('2017-12')
--PULL VENDOR_ID FROM TABLE WITH PARTICIPATING VENDORS (TO BE DONE SOON) AUTOMATICALLY
--WE INCLUDE SF TYPE DEAL FILTER 
